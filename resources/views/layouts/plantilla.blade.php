...
<body id="top">
    ...
    <header class="s-header">
        ...
        <div class="header-logo">
            <a class="site-logo" href="index.html">
                <img src="{{asset('images/iconorg.jpeg')}}" alt="Homepage">
            </a>
        </div>
    ...
    <!-- home
    ================================================== -->
    <section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="{{asset('images/001.jpg')}}" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
        ...
        <div class="home-content">
            ...
            <div class="row home-content__main">
                ...
                <h3><center>Bienvenido a Mundo ReGAming</center></h3>
    ...
    <!-- about
    ================================================== -->
    <!--<section id='Inicio' class="s-about">
    ...
    <!-- services
    ================================================== -->
    <section id='Filosofia' class="s-services">
